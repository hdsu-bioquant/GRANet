...
params:
  ...
  p_regulon           : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_10000/regulonAUC.RDS"
  sampleregulon: TRUE
  p_nmf : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_10000/NMF_sampled/NMF_regulonAUC.RDS"
  annotCol: "tissue"
editor_options: 
...
if (params$sampleregulon) {
  set.seed(1)
  idx <- sample(colnames(regulon), size=5000, replace=FALSE)
  regulon <- regulon[,idx]
  dim(regulon)
}
