---
title: "AdultLiver method 2 Regulon NMF"
author: "HDSU"
date: "`r date()`"
output: 
  html_document:
...
params:
  ...
  sampleregulon: TRUE
  p_nmf : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_500000/NMF_AdultLiver/NMF_regulonAUC.RDS"
  annotCol: "Annotation"
editor_options: 
...
regulonByType$AdultLiver
regulon <- regulon[sub(" \\(.*", "", rownames(regulon)) %in% regulonByType$AdultLiver$TF,]
dim(regulon)
...
unique(exprs$tissue)
exprs <- exprs[,exprs$tissue == "AdultLiver"]
dim(exprs)
