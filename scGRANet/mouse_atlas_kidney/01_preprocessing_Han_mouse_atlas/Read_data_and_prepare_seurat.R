...
byTissue <- cellAnnot %>% 
  group_by(tissue) %>% 
  summarise(n = n())
# Select only desired tissue
unique(cellAnnot$tissue)
cellAnnot <- cellAnnot %>% 
  dplyr::filter(tissue == "AdultLung")
...
saveRDS(seuratobj, "~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_AdultLung_Seurat.RDS")

# 
# loom
# 
# TFnames <- readLines("~/projects/mouse_brain_TF_activity/data/mm_mgi_tfs.txt")
# 
# 
# table(TFnames %in% x2$index)
# 
# 
# table(x1$index %in% cellAnnot$index)
# 
# 
# 
...
# select(org.Mm.eg.db, keys = x2$index, keytype = 'SYMBOL', columns = 'SYMBOL')
# 
# 
# 
# 
...
# 
# 
# #                     "~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_BatchRemoved_Merge_dge.h5seurat")
...
# # seuratObject <- LoadH5Seurat("~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_BatchRemoved_Merge_dge.h5seurat")
# # library(zellkonverter)
# # #rnaCounts <- zellkonverter::readH5AD("~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_BatchRemoved_Merge_dge.h5ad")
# 
# # cellAnnot <- read_csv("~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_CellAssignments.csv")
# # library(SeuratDisk)
# # SeuratDisk::Convert("~/projects/mouse_brain_TF_activity/data/scrna/Han_atlas/MCA_BatchRemoved_Merge_dge.h5ad", 
