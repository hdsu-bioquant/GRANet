...
# p_regulonAUCHeat     <- as.character(args[3])
# p_regulonAUCbinHeat  <- as.character(args[4])
...
motifDeviationAUC <- motifDeviationAUC[,colnames(regulonAUC)]
...
table(colnames(motifDeviationAUC) %in% colnames(regulonAUC))

regulonAUC_devCorrected <- regulonAUC[,colnames(motifDeviationAUC)] * motifDeviationAUC
sum(rowSums(regulonAUC_devCorrected) == 0 )
sum(colSums(regulonAUC_devCorrected) == 0 )
regulonAUC_devCorrected <- regulonAUC_devCorrected[rowSums(regulonAUC_devCorrected) > 0,]
