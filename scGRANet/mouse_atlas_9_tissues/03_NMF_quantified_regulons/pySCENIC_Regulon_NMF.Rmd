...
params:
  ...
  p_regulon           : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/scrna/SCENIC/auc_mtx.csv"
  p_regulonAUC_devCor : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_500000/regulonAUC.RDS"
  sampleregulon: TRUE
  p_nmf : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/scrna/SCENIC/NMF_sampled/NMF_regulonAUC.RDS"
  annotCol: "tissue"
editor_options: 
...
regulon <- read_csv(params$p_regulon) %>% 
  column_to_rownames("Cell") %>% 
  t()

#regulon <- readRDS(params$p_regulon)
regulonAUC_devCor <- readRDS(params$p_regulonAUC_devCor)

regulon <- regulon[,colnames(regulon) %in% colnames(regulonAUC_devCor)]
dim(regulon)

if (params$sampleregulon) {
  set.seed(1)
