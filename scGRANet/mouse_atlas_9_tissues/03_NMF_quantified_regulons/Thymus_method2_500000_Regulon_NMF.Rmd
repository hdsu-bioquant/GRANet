---
title: "AdultThymus method 2 Regulon NMF"
author: "HDSU"
date: "`r date()`"
output: 
  html_document:
...
params:
  ...
  p_regulonByType     : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_500000/tfRegulons_asDF.RDS"
  sampleregulon: TRUE
  p_nmf : "/home/bq_aquintero/projects/mouse_atlas_TF_activity/adult_9tissues/results/integrated/TF_activity_method2_500000/NMF_AdultThymus/NMF_regulonAUC.RDS"
  annotCol: "Annotation"
editor_options: 
...
# Keep only TF in cell type specific regulon
regulonByType$AdultThymus
regulon <- regulon[sub(" \\(.*", "", rownames(regulon)) %in% regulonByType$AdultThymus$TF,]
dim(regulon)
...
unique(exprs$tissue)
exprs <- exprs[,exprs$tissue == "AdultThymus"]
dim(exprs)
