...
```{r}
granetobj <- CreateGRAnetObject(SeuratObject = seuratobj, cssCluster = "tissue", 
                                genome = 'mm9',
                                Force=TRUE )
...
granetobj <- compute_coexpression_modules(GRANetObject = granetobj, 
                                          #TFs = head(readLines("data/mm_mgi_tfs.txt")), 
...
## GRANet step 2: Add motif postion in chromatin accessible regions for all cell types
