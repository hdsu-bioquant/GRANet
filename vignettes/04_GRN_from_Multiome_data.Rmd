...
hs_scCATseq_embryo
head(hs_scCATseq_embryo@meta.data)
```
...
#------------------------------------------------------------------------------#
## Create GRANet object
granetobj <- CreateGRANetMultiomeObject(SeuratObject  = hs_scCATseq_embryo,
                                        RNA_assay     = "RNA",
                                        ATAC_assay    = "ATAC",
                                        motifSet      = "cisbp",
                                        genome        = 'hg19')
...
granetobj@Reg_interactions$RegInteractionsBin[1:5,1:5]
head(granetobj@Reg_interactions$RegInteractionsTest)
...
annot <- granetobj@SeuratObject@meta.data
