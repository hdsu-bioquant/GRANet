...
#------------------------------------------------------------------------------#
regmat_umap <- uwot::umap(as.matrix(t(granetobj@Reg_interactions$RegInteractionsBin)),
                          pca = 50, pca_center = F, n_neighbors = 15,
                          n_components = 2, n_threads = 25)
plot(regmat_umap[,1], regmat_umap[,2])

annot <- granet_raw$annotation
