...
granetobj@Reg_interactions$RegInteractionsTest

x <- grep("FAM41C", rownames(granetobj@Reg_interactions$RegInteractionsBin), value = T)
table(sapply(strsplit(x, "_"), function(x){
  x[4]
}))
